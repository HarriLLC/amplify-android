...
internal class KotlinAuthFacadeInternal(private val delegate: RealAWSCognitoAuthPlugin) {
    ...
    suspend fun fetchAuthSession(userId: String): AuthSession = suspendCoroutine { continuation ->
    ...
    suspend fun signOut(userId: String): AuthSignOutResult = suspendCoroutine { continuation ->
